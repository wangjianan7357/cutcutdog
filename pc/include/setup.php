...
$ini_system = array(
	1 => array(
		...
		array('varname' => 'product_list_qty', 'info' => '产品列表显示数量', 'type' => 'integer', 'value' => 20),
		array('varname' => 'member_list_qty', 'info' => '会员列表显示数量', 'type' => 'integer', 'value' => 15),
		array('varname' => 'catalog_img_path', 'info' => '分类缩略图路径', 'type' => 'hidden', 'value' => 'uploads/pictures/catalog/'),
		array('varname' => 'info_img_path', 'info' => '信息缩略图路径', 'type' => 'hidden', 'value' => 'uploads/pictures/info/'),
		array('varname' => 'product_img_path', 'info' => '产品图路径', 'type' => 'hidden', 'value' => 'uploads/pictures/product/'),
		array('varname' => 'detail_img_path', 'info' => '细节图路径', 'type' => 'hidden', 'value' => 'uploads/pictures/detail/'),
		array('varname' => 'member_img_path', 'info' => '会员传图路径', 'type' => 'hidden', 'value' => 'uploads/member/'),
